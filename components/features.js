...
const TITLE_WITH_TRANSLATIONS = {
  "en-US": "Building tools and providing resources for the next generation of innovators.",
  "km-KH": "កសាងឧបករណ៍ និងផ្តល់ធនធានសម្រាប់អ្នកច្នៃប្រឌិតជំនាន់ក្រោយ។",
};
...
const FEATURES_WITH_TRANSLATIONS = {
  "en-US": {
      ...
      realtime: "Fast",
      suspense: "Manageable",
      pagination: "Customisable",
      backendAgnostic: "Cloudable",
      renderingStrategies: "Modular",
      typescript: "Neat",
      remoteLocal: "Wireless",
  },
  "km-KH": {
